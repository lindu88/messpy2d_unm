...
class AdaptiveTZViewer(QWidget):
    ...
    def __attrs_post_init__(self):
        ...
        self.setLayout(vlay(self.plot_widget, hlay(
            self.fit_text, pre_stretch=1, post_stretch=1), self.stop_button))
    ...
    def show_stop_options(self):
        ...
        save_button.clicked.connect(lambda: QMessageBox.information(
    ...
    def fit_data(self):
        ...
        if fit_res and fit_res.success:
            ...
            self.set_zero_btn.clicked.connect(
                lambda: self.plan.set_zero_pos(t0))
            self.set_zero_btn.clicked.connect(

...
import attr
import numpy as np
from MessPy.Plans.common_meta import Plan
import typing as T
...
from MessPy.Instruments.faulhaber import XYSingleFaulhaber
...
class FocusScan():
    ...
    def make_scan_gen(self):
        ...
        if self.scan_y:
            ...
            self.ytext_ref = make_text('y probe', self.fit_yref)

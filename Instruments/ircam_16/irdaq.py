...
#        self.reset()
    ...
    def write_out(self, val):
        ...
        self.out_task.WriteDigitalLines(1, 1, 0.001,
                                        PyDAQmx.DAQmx_Val_GroupByScanNumber,
                                        val,  byref(written) , None)
    ...
    def _write_lines(self, A, B):
        ...
        to_write[0] = A
        to_write[1] = B
        self.clock_task.WriteDigitalLines(1, 1, 0.001, PyDAQmx.DAQmx_Val_GroupByScanNumber, to_write,
                                      byref(written) , None)
...
#a = a.reshape(-1, 48)
    ...
    def check_ready(self):
        ...
        self.read_task.ReadDigitalLines(1, 1.0, PyDAQmx.DAQmx_Val_GroupByScanNumber, out, 8,
                      byref(read), byref(num_bytes), None)

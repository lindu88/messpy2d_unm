from nicelib import (load_lib, NiceLib, Sig, NiceObject,
             RetHandler, ret_ignore, ret_return)
import nidaqmx
...
class Cam:
    ...
    def init_imaq(self):
        ...
        IMAQ.imgSessionTriggerConfigure2(self.s, IMAQ.IMG_SIGNAL_EXTERNAL, IMAQ.IMG_EXT_TRIG0, IMAQ.IMG_TRIG_POLAR_ACTIVEH, 
    ...
    def set_shots(self, shots):
        ...
        N = shots
        print(N)
        self.task.timing.cfg_samp_clk_timing(1000, 'PFI0', c.Edge.RISING, sample_mode=c.AcquisitionType.FINITE, samps_per_chan=N)        

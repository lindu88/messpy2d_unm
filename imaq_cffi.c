...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_imaq_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_imaq_cffi(void) { return NULL; }
#  else
     initimaq_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_imaq_cffi(void)
{
  return _cffi_init("imaq_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initimaq_cffi(void)
{
  _cffi_init("imaq_cffi", 0x2601, &_cffi_type_context);
}
#endif
